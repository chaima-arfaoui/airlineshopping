...
public class Passenger {
	 @JsonProperty("Gender") 
		...
		public Passenger(String gender, Date dateOfBirth, String emailAddress, String phoneNumber,
				Date passportExpiresOn, String passportNationality, String passengerNationality, String postCode,
				String passportIssuanceCountry, String passengerType, PaxName paxName, String passportNumber,
				String nationalID, int nameNumber, String ticketStatus) {
			super();
			this.gender = gender;
			this.dateOfBirth = dateOfBirth;
			this.emailAddress = emailAddress;
