...
public class AirItineraryPricingInfoS {
	...
	public AirItineraryPricingInfoS(ItinTotalFare itinTotalFare, ArrayList<PTCFareBreakdown> pTC_FareBreakdowns,
	...
	public AirItineraryPricingInfoS() {
		super();
	}
